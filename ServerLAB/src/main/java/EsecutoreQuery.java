...
public class EsecutoreQuery implements SkeletonInterface{
	 ...
	 * @param host indirizzo della macchina sulla quale Ë situato il database
	 ...
	 * @return <b>1</b> se l'operazione Ë andata a buon fine
	 */
	...
	public synchronized int registraVaccinato(String nomeCentro, String nome, String cognome, String codiceFiscale,String dataSomministrazione, String tipoVaccino, String nDosi) throws SQLException {
		...
		if(rs.next()==false) {
			...
			//se non √® nella tabella dei vaccinati, lo aggiungo sia nei cittadini che nei vaccinati
			if(rs.next()==false) {
 ...
 */
	 ...
	 * @return <b>1</b> se la registrazione Ë andata a buon fine, <b>0</b> se la query Ë andata a buon fine ma il cittadino non Ë stato inserito (gi‡ presente), <b>-1</b> se la query non Ë andata a buon fine
	 */
	public synchronized int registrazioneCittadino(String nome, String cognome, String codiceFiscale, String eMail, String username, String password, String IdUnivoco) throws SQLException{
		...
		if(rs.next()) {
			...
			if(rs.next()==false) { 
				...
				System.out.println("Cittadino non inserito, gi√† presente");
 ...
 */
	...
	public synchronized boolean verificaCorrispondenzaId(String codiceFiscale, String idVaccinato) throws SQLException {
		...
		if(rs.next()) {
			...
			System.out.println("L'id della query √®: " + idQuery + ", l'id inserito dall'utente √®: " + idVaccinato);
			
			if(idQuery.equals(idVaccinato)) {
				return true; //buon fine 
			}
			else {
				System.out.println("L'ID NON √® UGUALE CAMBIARE!!!!");
				return false;
			}
		}
