...
public class EsecutoreQuery implements SkeletonInterface{
	 ...
	 * @return 1 se l'operazione Ë andata a buon fine
	 */
 ...
 */
	 ...
	 * @return 1 se la registrazione Ë andata a buon fine, 0 se la query Ë andata a buon fine ma il cittadino non Ë stato inserito (gi‡ presente), -1 se la query non Ë andata a buon fine
	 */
